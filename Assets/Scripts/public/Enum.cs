...
public static class Enum
{
    ...
    public static InvItem_Info[] INV_ITEM_INFO = new InvItem_Info[9 + 8 + 8 + 7] {
        ...
        // (연금술) 재료
        new InvItem_Info("1.흙덩어리", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("2.통나무", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("3.천조각", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("4.유리", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("5.슬라임", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("6.황금덩어리", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("7.석탄", "연금술에서 제작을위한 재료이다."),
        new InvItem_Info("8.천연소금", "연금술에서 제작을위한 재료이다."),
        // (버섯도감) 버섯
